        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GecisZamani = table.Column<DateTime>(type: "TEXT", nullable: false),
                    IslemTipi = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GecisLoglari", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GecisLoglari_Personeller_PersonelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GecisLoglari_PersonelId",
                table: "GecisLoglari",
                column: "PersonelId");
        }
